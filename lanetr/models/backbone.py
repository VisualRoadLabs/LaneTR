...
Por defecto **DLA-34** preentrenado en ImageNet (vía `timm`), que es el backbone de
CLRNet/CLRerNet. Devuelve los mapas a strides 8, 16, 32 con canales [128, 256, 512], que
