...
Esto elimina el desajuste train/eval con batches pequeños (el problema que vimos en el Paso
4.4) sin tener que congelar el backbone entero — sus pesos convolucionales sí pueden entrenar.
"""
